...
# # Dataset Pix3D
# __C.DATASET = edict()
# __C.DATASET.TRAIN_DATASET = 'ShapeNetChairRFC'
...
__C.TRAIN.MILESTONESLR.ENCODER_LR_MILESTONES = [60, 90, 110]
__C.TRAIN.MILESTONESLR.DECODER_LR_MILESTONES = [60, 90, 110]
__C.TRAIN.MILESTONESLR.MERGER_LR_MILESTONES = [60, 90, 110]
