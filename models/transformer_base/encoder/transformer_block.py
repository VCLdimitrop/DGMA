...
from models.transformer_base.attention import DGMAtention, STMAttention
...
class Block(torch.nn.Module):
    ...
    def forward(self, x, view_num=None, dgma=False):
        attn = self.attn(self.norm1(x), view_num=view_num, dgma=dgma)
