# References:
# - https://github.com/GaryZhu1996/GARNet/tree/main
# - https://github.com/LiyingCV/Long-Range-Grouping-Transformer

import torch
from einops import rearrange
from timm.models.vision_transformer import Mlp, partial
from models.transformer_base.decoder_refiner.standard_layers import Block as Blocks
...
class Decoder_Refiner(torch.nn.Module):
    def __init__(self, cfg):
        super(Decoder_Refiner, self).__init__()
        ...
        self.layer_norm = torch.nn.LayerNorm(cfg.NETWORK.MERGER.STM.DIM)
    ...
    def forward(self, context):
        ...
        x = self.conv1(out)  # torch.Size([batch_size, 64, 32, 32, 32])
